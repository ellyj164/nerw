...
/***/ "./assets/src/js/frontend/quiz/circle-progress-bar.js":
/*!************************************************************!*\
  !*** ./assets/src/js/frontend/quiz/circle-progress-bar.js ***!
  \************************************************************/
/***/ (() => {
...
/***/ "./assets/src/js/frontend/quiz/question-actions.js":
/*!*********************************************************!*\
  !*** ./assets/src/js/frontend/quiz/question-actions.js ***!
  \*********************************************************/
...
class QuestionActionHandler {
  ...
  handleCheckClick(e) {
    ...
    this.checkAnswer(questionId, answered, questionType).then(response => {
  ...
  createQuestionResponseManually(questionEl, response) {
    ...
    const labelText = isCorrect ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Correct', 'learnpress') : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Incorrect', 'learnpress');
    const responseHTML = `
  ...
  handleHintToggle(e) {
    ...
    (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.lpShowHideEl)(hintContent, isHidden ? 1 : 0);
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (QuestionActionHandler);

/***/ }),

/***/ "./assets/src/js/frontend/quiz/start-quiz.js":
/*!***************************************************!*\
  !*** ./assets/src/js/frontend/quiz/start-quiz.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class QuizStartHandler {
  ...
  async confirmRetake() {
    const result = await sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().fire({
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Retake Quiz?', 'learnpress'),
      text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Are you sure you want to retake the quiz?', 'learnpress'),
      icon: 'question',
      showCancelButton: true,
      confirmButtonText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Retake', 'learnpress'),
      cancelButtonText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Cancel', 'learnpress'),
  ...
  handleStartError(error, button) {
    ...
    (0,_lpToastify_js__WEBPACK_IMPORTED_MODULE_1__.show)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Failed to start quiz. Please try again.', 'learnpress'), 'error');
    button.classList.remove('loading');
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (QuizStartHandler);

/***/ }),

/***/ "./assets/src/js/frontend/quiz/submit-quiz.js":
/*!****************************************************!*\
  !*** ./assets/src/js/frontend/quiz/submit-quiz.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _lpToastify_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../lpToastify.js */ "./assets/src/js/lpToastify.js");
...
class QuizSubmitHandler {
  ...
  async performSubmission(button, options = {}) {
    ...
    button.disabled = true;
    button.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Submitting…', 'learnpress');
    button.classList.add('loading');
    ...
    // Submit quiz
    this.submitQuiz(answered, timeSpend).then(response => {
  ...
  async confirmSubmit() {
    const result = await sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Submit Quiz?', 'learnpress'),
      text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Are you sure you want to submit the quiz? You cannot change your answers after submission.', 'learnpress'),
      icon: 'warning',
      showCancelButton: true,
      confirmButtonText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Submit', 'learnpress'),
      cancelButtonText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Cancel', 'learnpress'),
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33'
    });
  ...
  handleSubmitSuccess(response, button) {
    if (response.status === 'success') {
      ...
      // Update button text
      button.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Submitted', 'learnpress');
      ...
      (0,_lpToastify_js__WEBPACK_IMPORTED_MODULE_2__.show)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Failed to submit quiz: ', 'learnpress') + (response.message || 'Unknown error'), 'error');
      button.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Submit Quiz', 'learnpress');
    }
  }
  ...
  handleSubmitError(error, button) {
    ...
    (0,_lpToastify_js__WEBPACK_IMPORTED_MODULE_2__.show)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Failed to submit quiz. Please try again.', 'learnpress'), 'error');
    button.textContent = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Submit Quiz', 'learnpress');
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (QuizSubmitHandler);

/***/ }),

/***/ "./assets/src/js/frontend/quiz/template-loader.js":
/*!********************************************************!*\
  !*** ./assets/src/js/frontend/quiz/template-loader.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    const callBack = {
      success: response => {
        ...
        if ('success' === status) {
          ...
          this.showError(targetElement, message || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Failed to load content', 'learnpress'));
        }
      },
      error: error => {
  ...
  showError(targetElement, error) {
    const errorMessage = `
            <div class="learn-press-message error">
                <p>${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Failed to load content. Please try again.', 'learnpress')}</p>
            </div>
        `;
    targetElement.insertAdjacentHTML('afterbegin', errorMessage);
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TemplateLoader);

/***/ }),

/***/ "./assets/src/js/frontend/quiz/timer.js":
/*!**********************************************!*\
  !*** ./assets/src/js/frontend/quiz/timer.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class QuizTimer {
  ...
  restoreFromLocalStorage() {
    try {
      ...
      if (savedStartTimestamp) {
        ...
        if (actualElapsedSeconds >= 0 && actualElapsedSeconds < 86400) {
          // Less than 24 hours
  ...
  formatTime(seconds, total) {
    ...
    if (total >= 3600) {
      ...
      secs = remainder % 60;
      return [hours, minutes, secs].map(val => val < 10 ? '0' + val : val).join(separator);
    } else {
      // Show MM:SS for durations < 1 hour
      minutes = Math.floor(seconds / 60);
      secs = seconds % 60;
      return [minutes, secs].map(val => val < 10 ? '0' + val : val).join(separator);
    }
  }
  ...
  async handleExpiration() {
    ...
    await sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Time Expired!', 'learnpress'),
      text: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Your quiz time has expired. The quiz will be submitted automatically.', 'learnpress'),
      icon: 'warning',
      confirmButtonText: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('OK', 'learnpress'),
      confirmButtonColor: '#3085d6',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initQuizTimer);
...
"use strict";
/*!*********************************************!*\
  !*** ./assets/src/js/frontend/quiz/quiz.js ***!
  \*********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _start_quiz_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./start-quiz.js */ "./assets/src/js/frontend/quiz/start-quiz.js");
/* harmony import */ var _submit_quiz_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./submit-quiz.js */ "./assets/src/js/frontend/quiz/submit-quiz.js");
/* harmony import */ var _question_actions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./question-actions.js */ "./assets/src/js/frontend/quiz/question-actions.js");
/* harmony import */ var _timer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./timer.js */ "./assets/src/js/frontend/quiz/timer.js");
/* harmony import */ var _template_loader_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./template-loader.js */ "./assets/src/js/frontend/quiz/template-loader.js");
/* harmony import */ var _circle_progress_bar_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./circle-progress-bar.js */ "./assets/src/js/frontend/quiz/circle-progress-bar.js");
/* harmony import */ var _circle_progress_bar_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_circle_progress_bar_js__WEBPACK_IMPORTED_MODULE_5__);
...
(function () {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => {
      new _start_quiz_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
      new _submit_quiz_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
      new _question_actions_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
      new _template_loader_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
      (0,_timer_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
    });
  } else {
    new _start_quiz_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    new _submit_quiz_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
